                ...
                <div class="col-12">
                    <div class="card" data-select2-id="30">
                        ...
                        <div class="card-body" data-seçected2-id="40">
                            <g:form controller="book" action="createBook">
                                <div class="row">
                                    <div class="col-6">
                                        <p>${message}</p>
                                        <div class="form-group">
                                            <label for="title">Title</label><br>
                                            <g:field  required="" class="form-control" id="title" type="text" name="title" placeholder="Input the title book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="subtitle">Subtitle</label><br>
                                            <g:field class="form-control" id="subtitle" type="text" name="subtitle" placeholder="Input the subtitle book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="edition">Edition</label><br>
                                            <g:field class="form-control" id="edition" type="text" name="edition" placeholder="Input the edition book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="isbn">ISBN</label><br>
                                            <g:field require="" class="form-control" id="isbn" type="text" name="isbn" placeholder="Input the ISBN book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="pageNumber">Page number</label><br>
                                            <g:field require="" class="form-control" id="pageNumber" type="text" name="pageNumber" placeholder="Input the page number book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="publication">Publication:</label><br>
                                            <g:field class="form-control" id="publication" type="date" name="publication" placeholder="Input the date of publication book"/><br>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <g:field  class="form-control" id="publisher" type="text" name="publisher" placeholder="Input the publisher book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="queue">Estante</label><br>
                                            <g:field require="" class="form-control" id="queue" type="text" name="queue" placeholder="Input the queue of book"/><br>
                                        </div>
                                        <div class="form-group">
                                            <label for="shelf">Prateleira</label><br>
                                            <g:field require="" class="form-control" id="text" type="text" name="shelf" placeholder="Input the shelf of book"/><br>
                                        </div>
