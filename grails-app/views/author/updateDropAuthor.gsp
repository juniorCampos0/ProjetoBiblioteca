...
<head>
    ...
    <title>Update: ${author.fullName}</title>
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Update or Drop Author</h1>
                    </div><!-- /.col -->
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
        </div>
                ...
                <div class="col-6">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-1">
                                    <a href="${g.createLink(controller: 'author', action: 'drop', params: [author: author.id])}"><i class="nav-icon fas fa-trash" style="border-left: 10px"></i></a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            ...
                            <g:form controller="author" action="update" params="[author: author.id]">
                                <div class="form-group">
                                    <label for="fullName">Old name: ${author.fullName}</label><br>
                                    <g:field  required="" class="form-control" id="fullName" type="text" name="fullName" placeholder="Input author full name"/><br>
                                </div>
                                <g:submitButton class="btn btn-primary" name="Update Author"/>
                            </g:form>
                        </div><!-- /.card-body -->
                    </div>
                    <!-- /.card -->
